...
Visualizes the multi-resolution Wendland RBF knot grid used for
DeepKriging's basis functions, overlaid on the IEEE 9500-node S2
feeder domain with the 4 measurement stations marked.

Run:
    python src/viz/plot_knots.py
...
# ── Build the figure ONCE, using the complete knot_levels list ────
